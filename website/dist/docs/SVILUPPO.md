...
**Riferimento di rilascio:** il profilo XLSX statico è incluso nella wheel qualificata `f426c5aa…`; non appartiene alla precedente `039e0fd8…`. Le suite installate su Python 3.13 e 3.11 sono concluse, così come installazione pulita e upgrade. Per hash ed esiti esatti consultare [VALIDAZIONE.md](VALIDAZIONE.md). Ogni successiva modifica richiede un’attribuzione distinta.

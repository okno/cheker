...
import launch_soak_features as launch_soak
...
class LauncherTests(unittest.TestCase):
    ...
    def test_selected_venv_symlink_is_preserved_and_io_is_detached(self):
        ...
        self.assertEqual(Path(command[2]).name, "soak_features.py")
        self.assertEqual(metadata["harness_profile"], "html-copies-v1")
